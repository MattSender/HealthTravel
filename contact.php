...
<!-- Titre de la Page -->
<title>HealtTravel | Contact</title>
...
<header id="home">
  ...
  <div class="text-box">
    ...
    <p>Notre équipe vous réponde 24h/24 7j/7 rapidement et efficacement !</p>
    <a class="btn" href="produit.php">Notre Produit</a>
    <a class="btn" href="contact.php">Page d'Accueil</a>
  </div>
...
<section class="team-section">
  ...
  <div class="team-card-wrapper">
    ...
    <div class="team-card">
      <div class="team-card-text">
        <h2>Matthieu Vacheron</h2>
        <h4>Principal Actionnaire</h4>
      </div>
      <div class="team-card-image">
        <img src="images/matthieu.jpg">
      </div>
    </div>
    <div class="team-card">
      <div class="team-card-text">
        <h2>Charles Radolanirina</h2>
        <h4>Principal Actionnaire</h4>
      </div>
      <div class="team-card-image">
    ...
    <div class="team-card">
      <div class="team-card-text">
        <h2>Louise-Anne Scraigne</h2>
        <h4>Jsp quoi mettre</h4>
      </div>
      <div class="team-card-image">
        <img src="images/luiza.jpg">
      </div>
    </div>
    
    <div class="team-card">
      <div class="team-card-text">
        <h2>Vianney Desbazeille</h2>
        <h4>Jsp quoi mettre</h4>
      </div>
      <div class="team-card-image">
        <img src="images/charles.jpg">
...
<div class="stylish">
  <div class="wrapper">
      <h2>BoiteX - Notice d'utilisation</h2>
      <hr>
      <p>Pour lire la notice d'utilisation de la BoiteX, cliquez sur le bouton ci-dessous :</p>
      <form action="fichiers/Notice_d_utilisation_BoiteX.pdf">
...
<div class="contact-us">
    <div class="wrapper">
        ...
        <hr>
        <p>Pour toute demande, remplissez le formulaire ci-dessous, ou envoyer nous un mail à l'adresse suivante : contact@healthtravel.fr</p>
        <br>
        <form action="post">
            <div class="left">
